      ...
      <Card className="glass border-border/40">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label>Email</Label>
            <Input value="john@example.com" readOnly className="bg-muted/20 border-border/40" />
          </div>
          <div className="space-y-2">
            <Label>Display Name</Label>
            <Input placeholder="John Doe" className="bg-muted/20 border-border/40" />
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Receive upload & search summaries</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Get notified when photos finish processing</p>
            </div>
            <Switch defaultChecked />
          </div>
        </CardContent>
